...
<<<<<<< HEAD
		...
		TransparentButton shopButton = new TransparentButton("Shop");
		...
		shopButton.setFont(new Font("Dialog", Font.PLAIN, 30));
		shopButton.setForeground(Color.WHITE);
		shopButton.setBounds(453, 362, 117, 54);
		panel.add(shopButton);
		
		
		TransparentButton startButton = new TransparentButton("Start");
		...
		startButton.setFont(new Font("Dialog", Font.PLAIN, 30));
		startButton.setForeground(Color.WHITE);
		startButton.setBounds(453, 202, 117, 54);
		panel.add(startButton);
		
		
		TransparentButton bankAccountButton = new TransparentButton("Bank Account");
...
<<<<<<< HEAD
		bankAccountButton.setFont(new Font("Dialog", Font.PLAIN, 20));
		bankAccountButton.setForeground(Color.WHITE);
		bankAccountButton.setBounds(6, 6, 223, 43);
		panel.add(bankAccountButton);
		
		
		TransparentButton settingsButton = new TransparentButton("Settings");
...
<<<<<<< HEAD
		settingsButton.setFont(new Font("Dialog", Font.PLAIN, 30));
		settingsButton.setForeground(Color.WHITE);
		settingsButton.setBounds(427, 268, 170, 82);
		settingsButton.setBackground(new Color(0,0,0,128));
