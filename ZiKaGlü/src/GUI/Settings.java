...
<<<<<<< HEAD
		...
		TransparentButton accessebilityModeButton = new TransparentButton("Accessebility Mode");
		accessebilityModeButton.setBounds(418, 39, 187, 29);
		panel.add(accessebilityModeButton);
